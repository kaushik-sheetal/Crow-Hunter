...
function draw (){
    ...
    if (gamestate===("start")){
        ...
        text("Kills : ",displayWidth/2,50);

        fill("blue");

        text(score,displayWidth-700,50)

        text("Hi Player! So you have to kill a total of ",550,200);
        text("10 crows through out the game.You can  ",550,230);
        text("control the player by touching wherever",550,260);
        text("you want the player to be and by ",550,290);
        text("tapping you can shoot.Click to start",550,320);
